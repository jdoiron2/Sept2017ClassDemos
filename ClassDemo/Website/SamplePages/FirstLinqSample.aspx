...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
    <asp:GridView ID="ArtistAlbumList" runat="server" AutoGenerateColumns="False" DataSourceID="ArtistAlbumListODS">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ArtistAlbumListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_ListforArtists" TypeName="ChinookSystem.BLL.AlbumController">
        <SelectParameters>
