    ...
    <uc1:MessageUserControl runat="server" ID="MessageUserControl" />
     ...
     <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-pane fade in active" id="listviewcrud">
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                                        ...
                                        <td>
                                           <%-- <asp:Label Text='<%# Eval("ArtistId") %>' runat="server" ID="ArtistIdLabel" />--%>
                                            <asp:DropDownList ID="ArtistIdDropDownList" runat="server"
                                                 DataSourceID="ArtistListODS"
                                                 DataTextField="Name"
                                                 DataValueField="ArtistId" Enabled="false"
                            ...
                            <asp:ObjectDataSource ID="ListViewCRUDODS" runat="server" DataObjectTypeName="Chinook.Data.Entities.Album"
         ...
         <%-- some people will collect all ODS controls and
              place them in a single location for easy access. The ODS controls are not
